          ...
          <section className="middle-section">
            <div className="left">
              ...
              <div className="h-btns">
                ...
                <button className="secondary-btn">More menu</button>
              </div>
            </div>
            <div className="right">
              <div className="img-container">
                <img src={coffeeCup} alt="coffee cup" />
                <div className="group element1">
                  <span>Cappuccino</span>
                </div>
                <div className="group element2">
                  <span>4.8</span>
                  <span>
                    <img src={starSvg} alt="star" />
                  </span>
                </div>
                <div className="group element3">
                  <span>18K</span>
                </div>
              </div>
            </div>
